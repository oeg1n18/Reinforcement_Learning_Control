classdef DDQN < handle
    ...
    properties
        ...
        agent; % evaulation nerual network
    ...
    methods
        ...
        function copy_weights_agent_to_target(obj)
            % Copy the weights of the evaluation netowork to target network
        ...
        function experience_replay(obj, batch_size) 
            ...
            % Q-learning equation then trains the evaluation netowork with
            % the targets
