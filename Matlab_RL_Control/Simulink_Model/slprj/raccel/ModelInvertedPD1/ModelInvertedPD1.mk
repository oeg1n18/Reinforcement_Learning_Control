...
MODEL                   = ModelInvertedPD1
MODULES                 = rt_logging.c ModelInvertedPD1.c ModelInvertedPD1_capi.c ModelInvertedPD1_data.c ModelInvertedPD1_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = ModelInvertedPD1
MAKEFILE                = ModelInvertedPD1.mk
MATLAB_ROOT             = /Applications/MATLAB_R2020b.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2020b.app
START_DIR               = /Users/olivergrainge/OneDrive\ -\ University\ of\ Southampton/Uni_year_three/Part\ 3\ Project/Matlab/SEMESTER2/Simulink_Model
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 6
COMPUTER                = MACI64
BUILDARGS               =  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="/Applications/MATLAB_R2020b.app" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=10.14"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/ModelInvertedPD1 \
