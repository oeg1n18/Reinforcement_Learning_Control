classdef CartPole < handle
    ...
    methods
        function obj = CartPole()
            ...
            obj.reset();
            obj.theta_bins = linspace((-45*pi/18),(45*180/pi),25);
            obj.thetadot_bins = linspace((-45*pi/18),(45*180/pi),25);
            obj.Kp_bins = 5:1.0:30;
            obj.Ki_bins = 0.5:1.0:20.5;
            obj.Kd_bins = 0.5:1.0:20.5;
        end
        ...
        function [reward, next_state,  failed, done] = take_action(obj, action)
            ...
            obj.state = [discretize(obj.Kp, obj.Kp_bins), discretize(obj.Ki, obj.Ki_bins), discretize(obj.Kd, obj.Kd_bins), discretize(obj.theta, obj.theta_bins), discretize(obj.theta_dot, obj.thetadot_bins)];
            reward = obj.reward;
