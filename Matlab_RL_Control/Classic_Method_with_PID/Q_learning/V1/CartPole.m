classdef CartPole < handle
    ...
    methods
        function obj = CartPole()
            ...
            obj.reset();
            obj.theta_bins = linspace(-45*pi/180, 45*pi/180, 1000);
            obj.theta_dot_bins = linspace(-500*pi/180, 500*pi/180, 1000);
        end
        ...
        function [reward, next_state,  failed, done] = take_action(obj, action)
            ...
            obj.state = [discretize(obj.theta, obj.theta_bins), discretize(obj.theta_dot, obj.theta_dot_bins)];
            reward = obj.reward;
